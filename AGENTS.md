...
4. 必须严格遵守 [`.agents/skills/beidou-development-principles/SKILL.md`](.agents/skills/beidou-development-principles/SKILL.md) 中定义的研发核心工作准则（严禁擅自脑补需求与添加暗箱特权、零假设与主动确认、严格遵守 Git 分支与部署规范、禁止擅自合并功能/修复类 PR）。
